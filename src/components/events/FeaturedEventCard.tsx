  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            'radial-gradient(circle at 82% 15%, rgba(124,58,237,0.2), transparent 34%), radial-gradient(circle at 72% 100%, rgba(47,230,176,0.09), transparent 34%)'
        }}
      />
        ...
        <div className="relative hidden overflow-hidden border-l border-border lg:block">
          ...
          <div className="relative flex h-full flex-col justify-between p-10">
            <div className="flex items-start justify-between">
              <div className="rounded-[20px] border border-border-hi bg-bg/70 px-6 py-5 text-center backdrop-blur-md">
                <div className="font-mono text-[12px] uppercase tracking-[0.18em] text-text-muted">
                  {event.dateLabel.month}
                </div>

                <div className="mt-1 font-display text-[52px] font-semibold leading-none text-mint">
                  {event.dateLabel.day}
                </div>
              </div>
            ...
            <div className="font-mono text-[12px]">
              ...
              <div className="space-y-4">
                <div className="flex items-start justify-between gap-5 border-b border-border pb-4">
                  ...
                  <span className="text-right text-text">{event.format}</span>
                </div>

                <div className="flex items-start justify-between gap-5 border-b border-border pb-4">
                  <span className="text-text-dim">location</span>
                  <span className="max-w-[220px] text-right text-text">
                ...
                <div className="flex items-start justify-between gap-5">
                  ...
                  <span className="text-mint">ready_to_join</span>
                </div>
              </div>
            </div>
