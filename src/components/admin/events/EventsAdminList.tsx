  ...
  return (
    <div className="mx-auto max-w-[960px]">
      <div className="mb-6 flex items-center justify-between gap-4">
        <div>
          <h1 className="font-display text-2xl font-bold text-text">Events</h1>
      ...
      {state === 'loading' && (
        <div className="flex items-center gap-3 py-16">
          ...
          <span className="font-mono text-sm text-text-muted">loading events…</span>
        </div>
      )}
              ...
              {events.map((event) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    ...
                    <p className="text-xs text-text-dim">{event.slug}</p>
                  </td>
                  <td className="px-4 py-3 text-text-muted">
                    {event.dateLabel.month} {event.dateLabel.day}
